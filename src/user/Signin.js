...
const Signin = (props) => {
    ...
    return (
        ...
        <Layout 
           title="Sign In" 
           description="Log in to your account and enjoy seamless access to our platform. If you don't have an account yet, you can easily create one. Sign in now and explore all the features!" 
