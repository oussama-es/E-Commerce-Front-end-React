            ...
            <div className="card">
                <div className="card-body">
                    ...
                    <ul className="list-group list-group-flush">
                        ...
                        <li className="list-group-item">
                            <Link className="nav-link" to="/category/list">View categories</Link>
                        </li>
                        {/* Ajoutez le lien vers la liste des produits ici */}
                        <li className="list-group-item">
                            <Link className="nav-link" to="/product/list">  View products</Link>
                        </li>
                        <li className="list-group-item">
